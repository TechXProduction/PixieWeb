...
export const Form = ({handleButtonClick}) => {
          ...
          <Box sx={{ borderRadius: "100px", background: "linear-gradient(to right, #70C0B2, #0198B6, #007289)", padding: "2px" }}>
            ...
            sx={{ "& .css-1t8l2tu-MuiInputBase-input-MuiOutlinedInput-input, & .css-1x5jdmq": {
             ...
             // helperText={formik.touched.name && formik.errors.name}
              InputProps={{ style: { borderRadius: "100px", background: "#202020", height: "43px" , color:"white"} }}
            />
          </Box>
        ...
        <Box sx={{ marginBottom: "24px" }}>
          ...
          <Box sx={{ borderRadius: "100px", background: "linear-gradient(to right, #70C0B2, #0198B6, #007289)", padding: "2px" }}>
            ...
            sx={{ "& .css-1t8l2tu-MuiInputBase-input-MuiOutlinedInput-input, & .css-1x5jdmq": {
              ...
              InputProps={{ style: { borderRadius: "100px", background: "#202020", height: "43px" , color:"white"},className: "custom-input", }}
              autoComplete="off"
            />
          </Box>
        ...
        <Box sx={{ marginBottom: "56px" }}>
          ...
          <Box sx={{ borderRadius: "30px", background: "linear-gradient(to right, #70C0B2, #0198B6, #007289)", padding: "2px" }}>
            ...
            sx={{ "& .css-1t8l2tu-MuiInputBase-input-MuiOutlinedInput-input , & .css-1x5jdmq": {
              ...
              InputProps={{ style: { borderRadius: "30px", background: "#202020", minHeight: "84px", color:"white" } }}
